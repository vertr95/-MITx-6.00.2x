...
#test_position = Position(0.6, 0.3)
#test_room.cleanTileAtPosition(Position(0.6, 0.3))
#print(test_room.isTileCleaned(0,3))
#test_position2 = Position(1.2, 4.5)
#test_room.cleanTileAtPosition(test_position2)
#print(test_room.getNumTiles())
#print(test_room.getNumCleanedTiles())
#random_position = test_room.getRandomPosition()
#print(random_position)
#print(test_room.isPositionInRoom(random_position))
...
#print(runSimulation(3, 1.0, 10, 10, 0.80, 2, StandardRobot))
